...
(function() {
  var api_sign_request, build_array, build_custom_headers, build_eager, build_upload_params, config, generate_transformation_string, get_api_url, identifier_pattern, option_consume, present, sha1, sign_request, timestamp, _;
